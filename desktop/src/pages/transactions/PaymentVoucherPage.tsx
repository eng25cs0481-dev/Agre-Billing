...
export default function PaymentVoucherPage() {
  ...
  const [voucherNo, setVoucherNo] = useState('PMT-0001');
    ...
    <div className="tp-voucher-frame" style={{ maxWidth: 750, margin: '0 auto', height: '100%', display: 'flex', flexDirection: 'column' }}>
      ...
      <div className="tp-voucher-top-info">
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <span className="tp-voucher-badge" style={{ backgroundColor: '#e11d48' }}>Payment</span>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          {saved && <span style={{ color: '#15803d', fontWeight: 'bold', fontSize: 12 }}>✓ Payment Recorded</span>}
      ...
      <div style={{ background: '#ffffff', border: '1px solid #cadfe8', padding: 20, flex: 1, overflowY: 'auto' }}>
        ...
        <div className="tp-voucher-party-row" style={{ marginBottom: 14 }}>
          <span className="tp-party-label" style={{ width: 180 }}>Account (Paid From)</span>
        ...
        {/* Particulars / Paid To */}
        <div className="tp-voucher-party-row" style={{ marginBottom: 14 }}>
          <span className="tp-party-label" style={{ width: 180 }}>Particulars (Paid To)</span>
          <span className="tp-colon">:</span>
          <div style={{ flex: 1 }}>
            <Autocomplete
              className="tp-party-input"
              style={{ width: '100%', fontWeight: 'bold' }}
              placeholder="Select Supplier or Expense Ledger..."
              value={supplierName}
        ...
        {/* Amount */}
        <div className="tp-voucher-party-row" style={{ marginBottom: 14 }}>
          <span className="tp-party-label" style={{ width: 180 }}>Amount Paid (₹)</span>
          <span className="tp-colon">:</span>
          <input
            type="number"
            className="tp-party-input"
        ...
        <div className="tp-voucher-party-row" style={{ marginBottom: 14 }}>
          ...
          <input
            type="text"
            className="tp-party-input"
            placeholder="Enter payment details or invoice settled..."
            value={narration}
